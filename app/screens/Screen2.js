  ...
  render() {
    return (
      <View style={{backgroundColor: '#fff', flex: 1, flexDirection: 'column'}}>
        <View style={{flexDirection:'column',flex:0.9,alignItems:'center',padding:deviceHeight * 0.02}}>
        <Text style={styles.textStyle}>
        Safety legislation structure  in Queensland
        </Text >
        <Image style={styles.imgcharStyle}
        size={deviceHeight * 0.01}
        source={require('../imgs/screen_2_6.png')}
        />
       <Image style={styles.imgcharStyle}
        size={deviceHeight * 0.01}
        source={require('../imgs/screen_2_1.png')}
        />
          <Image style={styles.imgcharStyle}
        size={deviceHeight * 0.01}
        source={require('../imgs/screen_2_2.png')}
        />
          <Image style={styles.imgcharStyle}
        size={deviceHeight * 0.01}
        source={require('../imgs/screen_2_3.png')}
        />
          <Image style={styles.imgcharStyle}
        size={deviceHeight * 0.01}
        source={require('../imgs/screen_2_4.png')}
        />
          <Image style={styles.imgcharStyle}
        size={deviceHeight * 0.01}
        source={require('../imgs/screen_2_5.png')}
        />
</View>
